...
from .src.pipeline.flash_head_pipeline import FlashHeadPipeline
from .src.distributed.usp_device import get_device, get_parallel_degree

# infer_params_path = Path(__file__).resolve().parent / "configs" / "infer_params.yaml"
...
def get_audio_embedding(pipeline, audio_array, audio_start_idx=-1, audio_end_idx=-1, infer_params=None):
